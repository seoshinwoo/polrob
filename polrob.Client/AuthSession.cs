...
{
    // 같은 Wi-Fi에 연결된 현재 MacBook(en0)의 IPv4 주소입니다.
    // iOS/Android 실기기는 이 주소로 MacBook의 HTTP/TCP/UDP 서버에 접속합니다.
    private const string LocalNetworkServerHost = "192.168.0.83";
